        ...
        <div>
            <div className=' mx-auto relative flex flex-col w-11/12 items-center justify-between text-white '>
                <Link onClick={() => { dispatch(setProgress(100)) }} to={"/signup"}>
                    <div className=' group mt-10 p-1 mx-auto rounded-full bg-richblack-800 font-bold transition-all duration-200 hover: scale-95 w-fit max-w-maxContent'>
                ...
                <div className='text-center text-3xl md:text-4xl font-semibold mt-3'>
                    Empower Your Journey to <HighlightText text={"Success"} />
                </div>
                <div className=' mt-4 w-[90%] text-left md:text-center text-sm md:text-lg font-bold text-richblack-300'>
                    Discover the power of coding with SkillMatrix
                </div>
                ...
                <div className=' shadow-blue-200 w-[50%] relative'>
                    <div className='grad2 -top-10 w-[500px]'></div>
            ...
            <source  src={Banner} type="video/mp4" />
                    ...
                    <img
                        src={home}
                        alt="timelineImage"
                        className='shadow-white mx-auto mb-4 block'
                    />
                </div>
                    ...
                    <div className='flex flex-row gap-5 mb-10 mt-[95px]'>
                        ...
                        <div className='flex flex-col gap-10 w-[40%] items-start'>
                            <div className='text-[16px]'>
                                The modern SkillMatrix is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills.
                            </div>
                            <CTAButton active={true} linkto={"/signup"}>
                                <div>
                                    Learn more
